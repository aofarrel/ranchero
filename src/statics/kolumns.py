...
equivalence = {
		...
		'organism': ['organism', 'organism_sciname', 'organism_common', 'organism_sam', 'tax_id_sam_ss_dpl29', 'Organism', 'scientific_name_sam', 'species_sam', 'common_name_sam', 'phenotype_sam', 'scientific_name_run', 'common_name_run'],

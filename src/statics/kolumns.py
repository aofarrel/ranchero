...
equivalence = {
		...
		'date_collected': ['date_collected', 'date_isolation', 'Collection_Date', 'collection_date_sam', 'sample_collection_date_sam_s_dpl127', 'collection_date_orig_sam', 'collection_date_run', 'date_coll', 'date', 'colection_date_sam', 'collectiondateym_sam'],
		...
		'organism': ['organism', 'organism_sciname', 'organism_common', 'organism_sam', 'Organism', 'scientific_name_sam', 'species_sam', 'common_name_sam', 'phenotype_sam', 'scientific_name_run', 'common_name_run'],

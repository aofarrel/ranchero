...
#Ranchero.print_col_where(tba6, 'acc', 'SRR21239817') # timecode
##Ranchero.print_col_where(tba6, 'acc', 'ERR1768629') # vanishes
##Ranchero.print_col_where(tba6, 'acc', 'ERR1768638') # vanishes
#
...
#
#print("DEBUG: SRR21239817::timecode")
#Ranchero.print_col_where(tba6, 'run_index', 'SRR21239817') # timecode
##Ranchero.print_col_where(tba6, 'acc', 'ERR1768629') # vanishes
##Ranchero.print_col_where(tba6, 'acc', 'ERR1768638') # vanishes
#
...
Ranchero.print_col_where(tba6, 'run_index', 'ERR181314') # seems to disappear later on
...
Ranchero.print_col_where(merged, 'run_index', 'ERR181314') # seems to disappear later on
...
Ranchero.print_col_where(merged_flat, 'run_index', 'ERR181314') # seems to disappear later, has sample index SAMEA1573039
...
Ranchero.print_col_where(merged_by_sample, 'sample_index', 'SAMN02586062') # multiple run accessions going into same date
Ranchero.print_col_where(merged_by_sample, 'sample_index', 'SAMEA1573039') # seems to disappear later, has run index ERR18131

print("DEBUG: SAMN33804027:: 1905")
Ranchero.print_col_where(merged_by_sample, 'sample_index', 'SAMN33804027') # 1905???
...
Ranchero.print_col_where(merged_by_sample, 'sample_index', 'SAMEA1573039') # seems to disappear, has run index ERR18131

menardo = Ranchero.rancheroize(Ranchero.from_tsv("./inputs/menardo_stripped.tsv"))
denylist = Ranchero.rancheroize(Ranchero.from_tsv("./inputs/denylist_2024-07-23.tsv"))
standford = Ranchero.rancheroize(Ranchero.from_tsv("./inputs/max_standford_trimmed.tsv"))
...
merged = Ranchero.merge_dataframes(merged, standford, merge_upon="sample_index", right_name="standford", put_right_name_in_this_column="collection")

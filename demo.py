...
view_cols = ['__index__run_id', # will only exist after rancheroization; we want it at the front
...
print(s1+s2)
Ranchero.super_print(mycobact_from_BigQuery.select(['__index__run_id', 'geoloc_info']), "country information after rancheroize, but before standardize_countries()")
...
print(s1+s2+s3)
Ranchero.super_print(mycobact_from_BigQuery.select(['__index__run_id', 'host']), "country information after rancheroize, but before standardize_hosts()")
...
Ranchero.super_print(mycobact_from_BigQuery.select(Ranchero.valid_cols(mycobact_from_BigQuery, ['__index__run_id', 'strain_sam_ss_dpl139', 'subtype_sam', 'organism', 'pathotype_sam', 'serotype_sam', 'serovar_sam', 'genotype_sam_ss_dpl92', 'scientific_name_sam', 'subgroup_sam', 'mlva___spoligotype_sam'])), "dataframe before standardizing taxonomic information")
...
Ranchero.super_print(mycobact_from_BigQuery.select(['__index__run_id', 'isolation_source']), "sample source information after rancheroize, but before standardize_sample_source()")
